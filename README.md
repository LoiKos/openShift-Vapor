...
```
docker build -t vapor_Image-candidate .
IMAGE_NAME=vapor_Image-candidate test/run
```
...
```
s2i build test/test-app vapor_Image vapor_Image-app
...
```
docker run -d -p 8080:8080 vapor_Image-app
```
